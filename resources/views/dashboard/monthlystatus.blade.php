...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    let montlyStatus = {!! $monthly_status !!}
    let valueFilter = montlyStatus.filter((datafilter) => datafilter.Tahun == currentYear);
  ...
  function filterYearData() {
    ...
    function drawChart() {
      let onprogress = 0; let open = 0; let hold = 0; let close = 0;
      let monthlyStatus = {!! $monthly_status !!}
      let valueFilter = monthlyStatus.filter((datafilter) => datafilter.Tahun == currentYear);
      console.table(valueFilter)
