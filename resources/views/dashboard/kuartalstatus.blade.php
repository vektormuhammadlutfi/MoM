  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between">
        <h3 class="mb-0"><i class="fa-solid fa-list text-success"></i> Kuartal Meeting</h3>
...
<script type="text/javascript">
    ...
    function drawChart() {
      ...
      let hold = 0;
      let closed = 0;
        @foreach($kuartal_status as $kuartal)
          @if($kuartal->sts_issue == 'On Progress')
            onprogress = <?php echo $kuartal->total_issues; ?>;
          @endif

          @if($kuartal->sts_issue == 'Open')
            open = <?php echo $kuartal->total_issues; ?>;
          @endif

          @if($kuartal->sts_issue == 'Close')
            closed = <?php echo $kuartal->total_issues; ?>;
          @endif
          
          @if($kuartal->sts_issue == 'Hold')
            hold = <?php echo $kuartal->total_issues; ?>;
          // @else
          //   var hold = 0;
          @endif
