    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <h2 class="mb-0"><i class="fa-solid fa-list text-primary"></i> Detail Branch</h2>
          <a href="" class="btn btn-info py-1"><i class="fa-solid fa-plus"></i> Kembali</a>
        </div>
        <hr class="mt-2 mb-4">
        ...
        <div class="container">
            <div class="container ">
                <div class="row">
                    <h4 class="col-3">Id Branch</h4>
                    <p class="col-6">ExampleValue </p>
                </div>
            </div>
            <hr class="mt-0">
            <div class="container ">
                <div class="row">
                    <h4 class="col-3">Nama Branch</h4>
                    <p class="col-6">ExampleValue </p>
                </div>
            </div>
            <hr class="mt-0">
            ...
            <div class="container ">
                <div class="row">
                    <h4 class="col-3">Nomor Telpon</h4>
                    <p class="col-6">ExampleValue </p>
                </div>
            </div>
            <hr class="mt-0">
