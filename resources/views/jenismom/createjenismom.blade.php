...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
  <div class="container-fluid">
    <!-- Nama Halaman/brand -->
    <a class="h2 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html"> Jenis MoM | Create Data</a>
  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between">
        <h3 class="mb-0"><i class="fa-solid fa-list" style="color: #181bb3"></i> Tambah Jenis Mom</h3>
      ...
      <div class="col-lg-12 mx-auto">
        <form action="/store" method="post">
          ...
          <div class="form-group">
            <label for="SBU">Nama Jenis Mom</label>
            <select class="form-control @error('sbu_name') is-invalid @enderror" name="sbu_name" id="SBU">
              ...
              @endforeach --}}
              <option class="dropdown-item" value="-">tes</option>
            </select>
            @error('sbu_name')
